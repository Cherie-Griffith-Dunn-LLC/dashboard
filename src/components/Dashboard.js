...
/**
 * CYPROSECURE - Multi-Tenant Dashboard with Navigation
 */
function Dashboard() {
    ...
    <div className={`dashboard-layout ${darkMode ? 'dark-theme' : 'light-theme'}`}>
            ...
            {!sidebarCollapsed && (
              <>
                ...
                <span className="nav-badge">
                  {isMSPOwner ? securityData.highAlerts : isBusinessOwner ? employees.reduce((sum, e) => sum + e.threats, 0) : currentUserData.threatCount}
                </span>
              </>
            )}
          </a>
      ...
      <div className={`dashboard-main ${sidebarCollapsed ? 'sidebar-collapsed' : ''}`}>
        ...
        <div className="content-area">
          {/* Dashboard Page - Only show when currentPage === 'dashboard' */}
          {currentPage === 'dashboard' ? (
            ...
            <div style={{padding: '40px 0'}}>
              ...
              <div style={{padding: '60px 40px', background: 'var(--bg-card)', border: '2px dashed var(--border-color)', borderRadius: '12px', textAlign: 'center', color: 'var(--text-secondary)', fontStyle: 'italic'}}>
