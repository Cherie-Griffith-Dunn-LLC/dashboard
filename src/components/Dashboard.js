  ...
  return (
    <div className={`dashboard-layout ${darkMode ? 'dark-theme' : 'light-theme'}`}>
      ...
      <aside className={`sidebar ${sidebarCollapsed ? 'collapsed' : ''}`}>
        ...
        {/* Mobile Defender Download Section */}
        {!sidebarCollapsed && (
          <div className="sidebar-download-section">
            <div className="download-header">
              <span className="download-icon">📱</span>
              <span className="download-title">Protect Your Mobile</span>
            </div>
            <p className="download-subtitle">Download Microsoft Defender</p>
            <div className="download-buttons">
              ...
              >
                ...
                <span className="btn-text">iOS/iPad</span>
              </a>
              <a 
            ...
            <p className="download-note">Required for mobile protection</p>
          </div>
        )}
